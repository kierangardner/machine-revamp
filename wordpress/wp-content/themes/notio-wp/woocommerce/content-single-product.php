...
?>
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( 'post thb-product-detail product-page ' . $product_style . ' ' . $product_full_width, $product ); ?>>
	<div class="row <?php echo esc_attr( $product_full_width === 'product-full-width-on' ? 'full-width-row no-padding' : '' ); ?>">
