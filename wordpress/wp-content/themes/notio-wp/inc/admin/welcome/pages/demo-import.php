...
<main id="thb-adm-popup">
	<div class="thb-popup-box">
		...
		<h3><?php esc_html_e( 'Import Content', 'notio' ); ?></h3>
		<p><?php esc_html_e( 'You can select import data type you want.', 'notio' ); ?></p>
		<form action="" method="post">
			<div class="thb-check-line">
				<div>
					<div>
						<input type="checkbox" name="ty-contents" id="ty-contents" class="child-opened thb-checked" checked>
						<label for="ty-contents"><?php esc_html_e( 'Contents', 'notio' ); ?></label>
					</div>
					<div class="child-check done">
						<input type="checkbox" name="ty-contents-media" id="ty-contents-media" class="thb-checked" checked>
						<label for="ty-contents-media"><?php esc_html_e( 'Media Files (Thumbnail images, etc.)', 'notio' ); ?></label>
					</div>
				</div>
				<div>
					<input type="checkbox" name="ty-theme-options" id="ty-theme-options" class="thb-checked" checked>
					<label for="ty-theme-options"><?php esc_html_e( 'Theme Options', 'notio' ); ?></label>
				</div>
				<div>
					<input type="checkbox" name="ty-widgets" id="ty-widgets" class="thb-checked" checked>
					<label for="ty-widgets"><?php esc_html_e( 'Widgets', 'notio' ); ?></label>
				</div>
			</div>
			<button type="submit" class="button button-primary"><?php esc_html_e( 'Import Selected', 'notio' ); ?></button>
		</form>
	</div>
</main>
...
<div class="theme-browser thb-demo-import thb-content">
	...
	if ( ! $cond && $thb_plugin ) {
		...
		?>
		<div class="thb-error">
			<p><span class="dashicons dashicons-warning"></span> Please install <strong>Notio Required Plugin</strong> on the previous tab first.</p>
		</div>
		<?php
	} else {
