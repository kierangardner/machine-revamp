...
function thb_theme_options() {
	...
	$custom_settings = array(
		...
		'settings' => array(
			...
			array(
				'label'   => esc_html__( 'Mobile Submenu Behaviour', 'notio' ),
				'id'      => 'submenu_behaviour',
				'type'    => 'radio',
				'desc'    => esc_html__( 'You can choose how your arrows signs work', 'notio' ),
				'choices' => array(
					array(
						'label' => esc_html__( 'Default - Clickable parent links', 'notio' ),
						'value' => 'thb-default',
					),
					array(
						'label' => esc_html__( 'Open Submenu - Parent links open submenus', 'notio' ),
						'value' => 'thb-submenu',
					),
				),
				'std'     => 'thb-submenu',
			...
			array(
				'label'   => esc_html__( 'Use Ajax Add To Cart?', 'notio' ),
				'id'      => 'shop_product_ajax_addtocart',
				'type'    => 'on_off',
				'desc'    => esc_html__( 'Would you like to use Ajax Add to Cart on product pages?', 'notio' ),
				'std'     => 'on',
				'section' => 'shop',
			),
			array(
			...
			array(
				'label'   => esc_html__( 'Use Combined JavaScript Library?', 'notio' ),
				'id'      => 'thb_combined_libraries',
				'type'    => 'on_off',
				'desc'    => esc_html__( 'When disabled, each javascript library will be loaded on its own. It will allow for greater control using plugins, but may hinder site speed as multiple files will be loaded instead of one.', 'notio' ),
				'std'     => 'on',
				'section' => 'misc',
			),
			array(
			...
			array(
				'id'      => 'font_cache_text',
				'label'   => esc_html__( 'Clear Font Cache', 'notio' ),
				'desc'    => __( 'If you cant find Google Webfonts inside the boxes below, you can clear your transient for the font cache here: <br><br> <a href="themes.php?page=ot-theme-options&thb_clear_font_cache=true" class="button button-primary">Clear Font Cache</a>', 'notio' ),
				'type'    => 'textblock',
				'section' => 'typography',
			),
			array(
			...
			array(
				'label'   => esc_html__( '<EM> Font', 'notio' ),
				'id'      => 'em_type',
				'type'    => 'typography',
				'desc'    => esc_html__( 'This adds a separate font for styling of EM tags so you can add stylish typographic elements.', 'notio' ),
				'section' => 'typography',
			),
			array(
				'label'   => esc_html__( '<label> Font', 'notio' ),
				'id'      => 'label_type',
				'type'    => 'typography',
				'desc'    => esc_html__( 'This adds a separate font for styling of label tags.', 'notio' ),
				'section' => 'typography',
			),
			array(
			...
			array(
				'label'   => esc_html__( 'Menu Font', 'notio' ),
				'id'      => 'menu_type',
				'type'    => 'typography',
			...
			array(
				'id'      => 'typography_tab4',
				'label'   => esc_html__( 'Shop Typography', 'notio' ),
				'type'    => 'tab',
				'section' => 'typography',
			),
			array(
				'label'   => esc_html__( 'Product Title on Shop Pages', 'notio' ),
				'id'      => 'shop_product_title',
				'type'    => 'typography',
				'desc'    => esc_html__( 'Typography Setting for the product titles on shop pages.', 'notio' ),
				'section' => 'typography',
			),
			array(
				'label'   => esc_html__( 'Product Title on Product Page', 'notio' ),
				'id'      => 'shop_product_detail_title',
				'type'    => 'typography',
				'desc'    => esc_html__( 'Typography Setting for the product titles on product pages.', 'notio' ),
				'section' => 'typography',
			),
			array(
				'label'   => esc_html__( 'Product Excerpt Text', 'notio' ),
				'id'      => 'shop_product_detail_excerpt',
				'type'    => 'typography',
				'desc'    => esc_html__( 'Typography Setting for the product excerpt on product pages.', 'notio' ),
				'section' => 'typography',
			),
			array(
				'id'      => 'typography_tab6',
				'label'   => esc_html__( 'Font Support', 'notio' ),
				'type'    => 'tab',
				'section' => 'typography',
			),
			array(
				'label'   => esc_html__( 'Google Font Subsets', 'notio' ),
				'id'      => 'font_subsets',
				'type'    => 'radio',
			...
			array(
				'label'   => esc_html__( 'Simple Footer Social Link Colors', 'notio' ),
				'id'      => 'footer_simple_color',
				'type'    => 'link_color',
				'desc'    => esc_html__( 'This changes social link colors for the Simple Footer.', 'notio' ),
				'section' => 'customization',
			),
			array(
			...
			array(
				...
				'label'   => esc_html__( 'Other', 'notio' ),
				'type'    => 'tab',
				'section' => 'customization',
			),
			array(
				'label'   => esc_html__( 'Custom 404 Page', 'notio' ),
				'id'      => '404_page_content',
				'type'    => 'page-select',
				'desc'    => esc_html__( 'This allows you to override default 404 page and show a custom page.', 'notio' ),
				'section' => 'customization',
			),
			array(
				'id'      => 'footer_tab1',
