...
function thb_get_portfolio_listing_templates( $template_list ) {
	...
	$template_list['portfolio_listing_17'] = array(
		'name'      => esc_html__( 'Portfolio-Listing - Style 17', 'notio' ),
		'thumbnail' => Thb_Theme_Admin::$thb_theme_directory_uri . 'assets/img/admin/demos/listing/list-e17.jpg',
		'cat'       => array( 'Portfolio-Listing' ),
		'sc'        => '[vc_row css=".vc_custom_1616238484895{padding-top: 76px !important;}"][vc_column width="1/2"][thb_highlighttype slide_text="<h2>*Selected Works*</h2>" animation="animation fade-in" thb_highlight_color="#faaeae" thb_text_color="#242527"][vc_column_text]<h3><strong>2016 - 2021</strong></h3>[/vc_column_text][/vc_column][vc_column width="1/2" el_class="medium-text-right"][vc_empty_space mobile_height="16px"][thb_button_text style="style4" link="url:%23|title:VIEW%20ALL%20WORKS"][/vc_column][/vc_row][vc_row thb_full_width="true" css=".vc_custom_1616356101370{padding-top: 20px !important;padding-bottom: 100px !important;}"][vc_column width="1/3" width="1/3" skrollr="true"][thb_portfolio_single hover_style="hover-style4" source="size:1|post_type:portfolio|by_id:276"][thb_portfolio_single hover_style="hover-style4" source="size:1|post_type:portfolio|by_id:269"][/vc_column][vc_column width="1/3"][thb_portfolio_single hover_style="hover-style4" source="size:1|post_type:portfolio|by_id:274"][vc_empty_space][thb_portfolio_single hover_style="hover-style4" source="size:1|post_type:portfolio|by_id:346"][vc_empty_space height="54px"][thb_portfolio_single hover_style="hover-style4" source="size:1|post_type:portfolio|by_id:275"][/vc_column][vc_column width="1/3" skrollr="true" skrollr_speed="175"][thb_portfolio_single hover_style="hover-style4" source="size:1|post_type:portfolio|by_id:272"][thb_portfolio_single hover_style="hover-style4" source="size:1|post_type:portfolio|by_id:273"][/vc_column][/vc_row]',
	);
