...
<section class="blog-section style4 <?php echo esc_attr( 'pagination-' . $blog_pagination_style ); ?>" data-count="<?php echo esc_attr( get_option( 'posts_per_page' ) ); ?>" data-security="<?php echo esc_attr( wp_create_nonce( 'thb_blog_ajax' ) ); ?>">
	<?php
		$i = 0;
	if ( have_posts() ) :
		while ( have_posts() ) :
