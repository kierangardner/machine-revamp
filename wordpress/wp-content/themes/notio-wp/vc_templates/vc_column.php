...
$el_class = $el_id = $width = $parallax_speed_bg = $parallax_speed_video = $parallax = $parallax_image = $video_bg = $video_bg_url = $video_bg_parallax = $css = $offset = $css_animation = $thb_video_bg = $thb_video_overlay_color = $bg_video_overlay = '';
$output   = '';
...
if ( $enable_parallax ) {
	$css_classes[] = 'parallax_bg';
}

if ( $skrollr ) {
	$css_classes[] = 'thb-parallax-element';

	$wrapper_attributes[] = 'data-parallax-element="-' . esc_attr( $skrollr_speed ) . '"';
}
...
$inner_attributes[] = 'class="vc_column-inner ' . esc_attr( trim( vc_shortcode_custom_css_class( $css ) ) ) . '"';
